// Fișier: src/app/page.js - VERSIUNE FINALĂ, COMPLETĂ, PENTRU LANSARE V1.0
...
export default function HomePage() {
  ...
  const handleFileChange = (e) => {
    ...
    if (selectedFile) {
      ...
      const MAX_SIZE_IN_BYTES = 4 * 1024 * 1024; // 4 MB
      if (selectedFile.size > MAX_SIZE_IN_BYTES) {
        setError('Fișierul este prea mare. Limita pentru versiunea curentă este de 4 MB.');
        setFile(null);
        return;
      }
      ...
      <main className="container">
        ...
        <section id="actions" style={{ background: 'none', boxShadow: 'none', padding: '0' }}>
          ...
          <p style={{textAlign: 'center', marginTop: '1rem', color: 'var(--color-text-muted)', fontSize: '0.9rem'}}>
            (Limită maximă fișier: 4 MB pentru versiunea curentă)
          </p>
